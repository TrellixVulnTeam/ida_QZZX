...
def resnet34(pre_trained=False, **kwargs):
...
def resnet50(pre_trained=False, **kwargs):
...
def resnet101(pre_trained=False, **kwargs):
...
def resnet152(pre_trained=False, **kwargs):
