...
from simexp.common import ComposableDataclass, LoggingMixin
...
class FitSurrogatesTask(ComposableDataclass, LoggingMixin):
    ...
    # url to a train dataset generated by the module `make_train_data`
    train_input_url: str

    # url to a test dataset generated by the module `make_test_data`
    test_input_url: str
