...
class SurrogatesFitter(ComposableDataclass, LoggingMixin):
    ...
    class Results:
        ...
        def __add__(self, other):
            ...
            return SurrogatesFitter.Results(np.concatenate((self.scores, other.scores)),
                                            self.all_concept_names,
                                            np.concatenate((self.influence_estimators, other.influence_estimators)),
                                            np.concatenate((self.perturbers, other.perturbers)),
                                            np.concatenate((self.detectors, other.detectors)),
                                            np.concatenate((self.train_sample_fractions, other.train_sample_fractions)),
                                            np.concatenate((self.perturb_fractions, other.perturb_fractions)))
